...
// IF ZOOM -> ALORS ALIGN SELF CHANGE POUR MAIN
function reportWindowSize() {
    let bwidth = document.body.offsetWidth;
    let mwidth = main.offsetWidth;
    
    if(bwidth <= mwidth){
        main.style.alignSelf = 'flex-start';
    }
    else if(bwidth > mwidth){
...
document.addEventListener('mousedown', (e)=>{
    ...
    // charger img de fond
    if(e.target == document.querySelector('.bg-img use') || e.target == document.querySelector('.bg-img svg')){ 
        if(typeof main.style.backgroundImage === 'undefined' || main.style.backgroundImage === '' || main.style.backgroundImage === 'none'){
            main.style.backgroundImage = 'url("' + document.querySelector('#bg-url').value + '")';
        }
        else{
